...
def banner():
	...
	print("")
	print("%s\033[1;32m╔══════════════════════════════════════════╗"%(Z))
	print("%s\033[1;91m║%s  Author\033[1;91m  :%sACTION-FIRE\033[1;91m                     %s║"%(Z,B,M,Z))
	print("%s\033[1;91m║%s  Github\033[1;91m  : github.com/ACTION-FIRE\033[1;91m         %s║"%(Z,B,Z))
	print("%s\033[1;91m║%s  Facebook\033[1;91m: facebook.com/ft.alvi.18\033[1;91m        %s║"%(Z,B,Z))
	print("%s\033[1;91m║%s  Version\033[1;91m : %sV.3.0\033[1;91m                  %s║"%(Z,B,H,Z))
	print("%s\033[1;32m╚══════════════════════════════════════════╝"%(Z))
	print("")
