...
def banner():
	...
	print("")
	print("%s\033[1;91m╔════════════════════════════════════════╗"%(Z))
        print("%s\033[1;32m║\033[1;32m[•] Author    \033[1;32m : ACTION-FIRE            \033[1;32m║"%(Z,B,M,Z))    
        print("%s\033[1;32m║\033[1;32m[•] Facebook   \033[1;32m: Ft Alvi                ║"%(Z,B,Z))
        print("%s\033[1;32m║\033[1;32m[•] Github    \033[1;32m : github.com/ACTION-FIRE ║"%(Z,B,Z))
        print("%s\033[1;32m║\033[1;32m[•] Status    	\033[1;32m: FREE TRIAL             \033[1;32m║"%(Z,B,H,Z))
        print("%s\033[1;32m║\033[1;32m[•] Network    \033[1;32m: 3G, 4G/5G, ON          \033[1;32m║"%(Z,B,M,Z))
        print("%s\033[1;32m║\033[1;32m[•] Version  	\033[1;32m: V:2.1                  ║"%(Z,B,Z))
        print("%s\033[1;32m║\033[1;32m[•] Tools    	\033[1;32m: RAN/DOM Cloning        \033[1;32m║"%(Z,B,H,Z))
        print("%s\033[1;32m║════════════════════════════════════════║
        print("%s\033[1;32m║════════════════════════════════════════║
        print("%s\033[1;32m║              \033[1;32mAlvi MENU [👑]            ║"%(Z,B,Z))
        print("%s\033[1;91m╚════════════════════════════════════════╝""")"%(Z))
	print("")
